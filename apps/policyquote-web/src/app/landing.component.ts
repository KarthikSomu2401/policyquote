      ...
      <section class="section" data-testid="why-section" aria-labelledby="why-title">
        ...
        <div class="card-grid">
          <article class="reassurance-card">
            <img class="icon" src="assets/icons/shield-check.svg" alt="" aria-hidden="true" width="24" height="24" />
            <h3>Clear starting point</h3>
            <p>Share practical details in one focused form before you explore your quote.</p>
          </article>

          <article class="reassurance-card">
            <img class="icon" src="assets/icons/clock.svg" alt="" aria-hidden="true" width="24" height="24" />
            <h3>Designed for busy lives</h3>
            <p>Keep the process focused, with the important questions together and easy to scan.</p>
          </article>

          <article class="reassurance-card">
            <img class="icon" src="assets/icons/check.svg" alt="" aria-hidden="true" width="24" height="24" />
            <h3>Useful detail</h3>
